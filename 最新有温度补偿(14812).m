...
s = [0 1 4 8 12];
% FBG1_lambda0 = 1553.266e3 - 5.69e3 - delta_T*KT1; %20℃初始中心波长 单位pm
FBG1_lambda0 = 1547.4694e3; %20℃
% FBG1_lambda0 = 1547.593e3; %28℃
...
% FBG2_lambda0 = 1538.3003e3 - 5.69e3 - delta_T*KT2; %20℃初始中心波长
FBG2_lambda0 = 1532.5388e3;%20℃
% FBG2_lambda0 = 1532.6525e3; %28℃
...
text(0,0,1548, {'k_{s1} = 144.083pm/mm, R^2=0.9998','k_{ε1} = 0.843pm/με, R^2=0.9998'}, 'FontName', 'Times New Roman', 'FontSize', FontSize);
...
scatter3(s,FBG2_epsilon,FBG2_lambda/1000);hold on;
plot3(FBG2_fit_s,FBG2_fit_epsilon,FBG2_s_fit_lambda/1000);
text(0,0,1533, {'k_{s2} = -82.84pm/mm, R^2=0.9988','k_{ε2} = 0.970pm/με, R^2=0.9988'}, 'FontName', 'Times New Roman', 'FontSize', FontSize);
set(gca, 'FontName', 'Times New Roman', 'FontSize', FontSize);
xlabel('s/mm', 'FontName', 'Times New Roman', 'FontSize', FontSize);
