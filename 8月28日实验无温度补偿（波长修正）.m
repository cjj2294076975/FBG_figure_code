...
L = L1+L2; %固定端到自由端距离
s0 = 36.60; %初始位移
disp(['自由端距离FBG1',string(20),'FBG1距离FBG2',string(20),'FBG2距离固定端',string(L1)]);
...
FBG1_lambda(2) = 1553.415e3 - 5.69e3; %1554.28575
...
ylabel("FBG1 ε/με", 'FontName', 'Times New Roman', 'FontSize', FontSize);
zlabel('FBG1 Δλ_B/nm', 'FontName', 'Times New Roman', 'FontSize', FontSize);
grid on;
...
set(gca, 'FontName', 'Times New Roman', 'FontSize', FontSize);
xlabel('s/mm', 'FontName', 'Times New Roman', 'FontSize', FontSize);
ylabel("FBG2 ε/με", 'FontName', 'Times New Roman', 'FontSize', FontSize);
zlabel('FBG2 Δλ_B/nm', 'FontName', 'Times New Roman', 'FontSize', FontSize);
grid on;

%% 末端位移
% b = 15e-3/2; %纤芯直径15-50um
b = 0;
point_num = 12; % 1-13: 2 5 8 12
