...
s = [0 1 4 8 12];
FBG1_lambda0 = 1553.266e3 - 5.69e3; %28℃
% FBG1_lambda0 = 1547.4694e3;
FBG1_lambda = [1553.266 1553.4135 1553.8665 1554.4196 1555.0]*1e3 - 5.69e3;
...
FBG1_kb_s_corr_matrix = corrcoef(s, FBG1_delta_lambda);
% FBG1_kb_s_R2 = FBG1_kb_s_corr_matrix(1, 2)^2
...
% FBG1_k_epsilon = FBG1_kb_s(1)/k1 %应变灵敏度
...
% FBG2_lambda0 = 1532.5388e3; %20摄氏度
FBG2_lambda = [1538.3003 1538.2257 1537.950 1537.6185 1537.3164]*1e3 - 5.69e3;
...
FBG2_kb_s_corr_matrix = corrcoef(s, FBG2_delta_lambda);
FBG2_kb_s_R2 = FBG2_kb_s_corr_matrix(1, 2)^2;
...
FBG2_kb_epsilon_corr_matrix = corrcoef(FBG2_epsilon, FBG2_delta_lambda);
FBG2_kb_epsilon_R2 = FBG2_kb_s_corr_matrix(1, 2)^2;
...
mesh_x = [X X X];
mesh_x = sort(mesh_x);
mesh_y = [linspace(-12.5,-12.5,101) Y linspace(12.5,12.5,101)];
mesh_y = sort(mesh_y);
...
ax.TickDir = 'in';
% FontSize = 14;
% figure(10); %FBG1 位移 - 波长变化量 - 应变
% scatter3(s,FBG1_epsilon,FBG1_delta_lambda/1000);hold on;
% plot3(FBG1_fit_s,FBG1_fit_epsilon,FBG1_s_fit_delta_lambda/1000);
% text(0, 100, {'k_{s1} = 144.083pm/mm, R^2=0.9998','k_{ε1} = 0.843pm/με, R^2=0.9998'}, 'FontName', 'Times New Roman', 'FontSize', FontSize);
% set(gca, 'FontName', 'Times New Roman', 'FontSize', FontSize);
% xlabel('s/mm', 'FontName', 'Times New Roman', 'FontSize', FontSize);
% ylabel("ε_1/με", 'FontName', 'Times New Roman', 'FontSize', FontSize);
% zlabel('Δλ_{B1}/nm', 'FontName', 'Times New Roman', 'FontSize', FontSize);
% grid on;
% 
% figure(11); %FBG1 位移 - 波长变化量 - 应变
% scatter3(s,FBG2_epsilon,FBG2_delta_lambda/1000);hold on;
% plot3(FBG2_fit_s,FBG2_fit_epsilon,FBG2_s_fit_delta_lambda/1000);
% text(0, 100, {'k_{s2} = -82.84pm/mm, R^2=0.9988','k_{ε2} = 0.970pm/με, R^2=0.9988'}, 'FontName', 'Times New Roman', 'FontSize', FontSize);
% set(gca, 'FontName', 'Times New Roman', 'FontSize', FontSize);
% xlabel('s/mm', 'FontName', 'Times New Roman', 'FontSize', FontSize);
% ylabel("ε_2/με", 'FontName', 'Times New Roman', 'FontSize', FontSize);
% zlabel('Δλ_{B2}/nm', 'FontName', 'Times New Roman', 'FontSize', FontSize);
